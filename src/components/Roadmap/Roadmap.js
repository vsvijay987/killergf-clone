            ...
            <div className={styles.timeline}>
                <div className={[styles.timelineBox, styles.left].join(" ")}>
                    <div class={styles.timelineContainer}>
                        ...
                        <ul className="pl-16 font-para list-disc list-outside">
                ...
                <div className={[styles.timelineBox, styles.left].join(" ")}>
                    <div className={styles.timelineContainer}>
                        ...
                        <ul className="font-para pl-16 list-disc list-outside">
                ...
                <div className={[styles.timelineBox, styles.left].join(" ")}>
                    <div className={styles.timelineContainer}>
                        ...
                        <ul className="font-para list-disc list-outside pl-16">
                ...
                <div className={[styles.timelineBox, styles.right].join(" ")}>
                    <div className={styles.timelineContainer}>
                        ...
                        <ul className="font-para list-disc pl-16 list-outside">
